...
| **短视频跟练** | 📺 **短句和短语讲解大全**：借鉴「日常西语口语跟练」短视频——整句 + 中文，逐词拆解成词块，自动语音跟读时给当前词块画**红色下划线**、浮现手写红笔语法批注（连接词 / 动词 / 反身代词…），5 大主题 33 条地道墨西哥短句 |
...
src/app.js       学习模式、短句跟练、SRS 复习、TTS、录音、进度存储
src/data.js      10 个单元的词汇数据 + 短句短语讲解数据（整句 + 逐词拆解）
```
