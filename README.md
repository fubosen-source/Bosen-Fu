...
| 项目 | 说明 | 怎么打开 |
|---|---|---|
| 🏖️ [四年级暑假快乐复习营](summer-review/) | 英语 / 数学 / 科学三科暑假复习网站：动画演示 + 小游戏 + 闯关测验 | 直接双击 `summer-review/index.html`（无需安装任何东西） |
| 🇲🇽 PalabraPad（下文） | 墨西哥西班牙语学习 App (macOS) | `npm install && npm start` |
...
| 书写画布 + 键入练习 | ✍️ 书写练习：四线格打字（默认）——键入的字母实时"写"进四线格，打错闪红自动忽略，描红关掉即默写；也可切换成手写画布临摹（Clear / Undo / 描红开关、á é í ó ú ñ ü ¿ ¡ 特殊字符键） |
